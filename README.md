...
##Custom Regex
When using the --keyword(-k) option you can submit regular expressions. However, it is neccesary to escape any special characters. For example, the syntax to find any tables or column names that contain 1 to 4 characters would be:
